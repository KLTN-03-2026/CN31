...
const userRoleLabel = computed(() => roleLabels[props.user?.vai_tro] || 'Nhân sự');
</script>

<template>
    <div class="relative group ml-2">
        <button class="flex items-center gap-2 hover:bg-slate-50 p-1 rounded-full border border-transparent hover:border-slate-200 transition">
