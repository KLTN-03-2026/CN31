...
class TruongPhongWorkspaceController extends Controller
{
     ...
     * Handles department budget overview, pending approvals, and team management.
     */
    public function index(Request $request)
    {
        ...
        if (! $user->isTruongPhong()) {
            abort(403, 'Bạn không có quyền truy cập Không gian làm việc Trưởng phòng.');
        }

        $phongBanId = $user->phong_ban_id;
        $phongBan = $user->phongBan;

        // Core Query: Pending Approvals for this Department
